...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-header py-2">
    	<div class="container-fluid">
    		<a href="" class="navbar-brand">Eco NaturaLuxe</a>
    		...
    		<div class="collapse navbar-collapse" id="naff">
				...
				<ul class="navbar-nav ms-auto">
    				...
    				<li class="nav-item">
    					<a href="<?php echo base_url("logout") ?>" class="nav-link ">Keluar</a>
    				</li>
				</ul>
				<?php endif ?>
				...
				<?php if (!$this->session->userdata("id_member")): ?>
					<ul class="navbar-nav ms-auto">
						<li class="nav-item">
							<a href="#" data-bs-toggle="modal" data-bs-target="#login" class="nav-link">Masuk</a>
						</li>
