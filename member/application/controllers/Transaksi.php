...
class Transaksi extends CI_Controller {
    ...
    public function index() {
        ...
        //panggil model Mtransaksi dan fungsi tampil fungsi transaksi_member_beli(id_member yg login)
    ...
    function detail($id_transaksi) {
        ...
        if ($data["transaksi"]["id_member"]!==$this->session->userdata("id_member")) {
            $this->session->set_flashdata('pesan_gagal', 'tidak valid');
            redirect('transaksi','refdersh');
        }
        ...
        if($data['transaksi']['status_transaksi']=="pesan") {
            ...
            \Midtrans\Config::$serverKey = 'SB-Mid-server-1w-w0NLFsAR1ldOJZG7mMVKb';
            ...
            CURLOPT_HTTPHEADER => array(
                "accept: application/json","authorization: Basic U0ItTWlkLXNlcnZlci0xdy13ME5MRnNBUjFsZE9KWkc3bU1WS2I6YW1pa29t"
            ),
            ));
